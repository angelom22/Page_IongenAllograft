            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcumb-content">
                        <h3 class="breadcumb-title">Benefits and Services</h3>
                        <p>In this section you can see in detail what are the great benefits of this miracle injection as is the 100% Pure Amniotic Fluid</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading">
                        <h2>Benefits of 100% Pure Amniotic Fluid </h2>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-md-4">
                    <div class="single-benefits-area mb-50 text-right">
                        ...
                        <p>Safe, non-steroidal alternative to surgery.</p>
                    </div>
                    <div class="single-benefits-area mb-50">
                        <div class="single-benefits-title d-flex align-items-end row-reverse">
                            <i class="icon-cardiogram-4"></i>
                            <h5>All natural and drug-free</h5>
                        </div>
                        <p>Because a 100% pure liquid naturally conceived by the body is used in the same way in our patients.</p>
                    </div>
                    <div class="single-benefits-area mb-50">
                        <div class="single-benefits-title d-flex align-items-end row-reverse">
                            <i class="icon-clock"></i>
                            <h5>Reduced recovery time</h5>
                        </div>
                        <p>The time to recover 100% from a muscle or other injury is very short as this injection has an immediate effect on the body.</p>
                    </div>                   
                ...
                <div class="col-12 col-md-4">
                    <div class="single-benefits-area mb-50 text-right">
                        ...
                        <p>Prevents or decreases tissue inflammation.</p>
                    </div>
                    
                    <div class="single-benefits-area mb-50">
                        <div class="single-benefits-title d-flex align-items-end">
                            <i class="icon-molecules"></i>
                            <h5>Contains more than 200 growth factors</h5>
                        </div>
                        <p>Because it is a natural liquid it is composed of many natural factors such as stem cells that help the growth and recovery of tissues.</p>
                    </div>
                    <div class="single-benefits-area mb-50 text-right">
                        <div class="single-benefits-title d-flex align-items-end ">
                        ...
                        <p>Prevents or kills microorganisms by stopping their growth.</p>
                    </div>
