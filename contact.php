...
<body>
    ...
    <section class="breadcumb-area bg-img gradient-background-overlay" style="background-image: url(img/bg-img/hero1.jpg);">
                ...
                <div class="col-12 col-lg-8">
                    <div class="contact-form">
                        ...
                        <form action="#" method="post">
                            ...
                            <button type="submit" class="btn medilife-btn">Send</button>
                        </form>
                    </div>
                </div>
                        ...
                        <div class="medilife-contact-card mb-50">
                            ...
                            <div class="single-contact d-flex align-items-center">
                                ...
                                <div class="contact-meta">
                                    <p>Address: USA, 1481 Creekside Lane Avila <br>Miami, Beach </p>
                                </div>
                            </div>
                            ...
                            <div class="single-contact d-flex align-items-center">
                                ...
                                <div class="contact-meta">
                                    <p>Email: contact@iongenallograft.com</p>
                                </div>
                            </div>
