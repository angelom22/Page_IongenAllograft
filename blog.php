...
<body>
    ...
    <section class="breadcumb-area bg-img gradient-background-overlay" style="background-image: url(img/bg-img/g5.jpg);">
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcumb-content">
                        <h3 class="breadcumb-title">Relevant News</h3>
                        <p>Find out all the advances about this new clinical product, among other news related to the world of advanced medicine.</p>
                    </div>
                </div>
            </div>
        </div>
