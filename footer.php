                ...
                <div class="col-12 col-sm-6 col-xl-3">
                    <div class="footer-widget-area">
                        <div class="footer-logo">
                            <p>Logo Iongen Allograft</p>
                            <!-- <img src="img/core-img/logo.png" alt=""> -->
                        </div>
                        <p>Our trademark Iongen Allograft is certified nationally, to consult about our credibility we invite you to follow us in our different social networks.</p>
                ...
                <div class="col-12 col-sm-6 col-xl-3">
                    <div class="footer-widget-area">
                        ...
                        <div class="footer-newsletter-area">
                            <form action="#">
                                <input type="email" class="form-control border-0 mb-0" name="newsletterEmail" id="newsletterEmail" placeholder="please enter your email">
                                <button type="submit">Subscribe</button>
                            </form>
                            <p>To receive information about our advances in medicine, lectures, conferences, and promotions, we invite you to subscribe to our website, just by registering your email address.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="bottom-footer-content">
                        ...
                        <div class="copywrite-text">
                            <p>
                        Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | IONGEN ALLOGRAFT </p>
                        </div>
                    </div>
                </div>
            </div>
