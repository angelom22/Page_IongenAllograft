            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcumb-content">
                        <h3 class="breadcumb-title">About our product</h3>
                        <p>100% pure amniotic liquid</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-8">
                    <div class="video-box bg-overlay-black">
                        <img src="img/bg-img/video2.jpg" alt="Amniotic Injection Video">
                        <div class="play-btn">
                            <a class="popup-video" href="https://www.youtube.com/watch?v=vwZcHMJnk4A&feature=youtu.be"><img src="img/core-img/play.png" alt="Amniotic Injection for Achilles tendinitis and Plantar Fasciitis"></a>
                            <h6>Amniotic Injection-Video</h6>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-lg-4">
                    <div class="video-content">
                        <h2>Amniotic Injection</h2>
                        <p align="justify">While 100% pure amniotic fluid contains an impressive array of regenerative factors, no live stem cells, dead tissue or waste are present in this product, as the FDA does not allow stem cells to be present in any amniotic product at this time.  The product is intended to enable your body's ability to repair itself by recruiting its own cells to do the job.<br>All 100% pure amniotic fluid products are volunteers from pre-selected healthy donors who have been thoroughly tested for disease and obtained during full-term cesarean deliveries.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-sm-6 col-md-3 col-lg-2">
                    <div class="single-pie-bar" data-percent="200">
